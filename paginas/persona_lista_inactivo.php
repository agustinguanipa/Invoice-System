	    	...
	    	<div class="table-responsive">
					<table class="table table-striped table-hover">
						...
						//Paginador 
							...
							$sql_registe = mysqli_query($conexion,"SELECT COUNT(*) as total_registro FROM tab_per WHERE statu_per = 0");
							...
							$query = mysqli_query($conexion,"SELECT u.ident_per, u.cedul_per,u.nombr_per, u.apeli_per, u.telem_per, u.email_per, u.usuar_per, r.ident_tip, r.nombr_tip FROM tab_per u INNER JOIN tab_tip r ON u.ident_tip = r.ident_tip WHERE statu_per = 0  ORDER BY ident_per ASC LIMIT $desde,$por_pagina");
