	    	...
	    	<div class="table-responsive">
					<table class="table table-striped table-hover">
						...
						//Paginador 
							...
							$sql_registe = mysqli_query($conexion,"SELECT COUNT(*) as total_registro FROM usuario WHERE estatus = 0");
						...
						$query = mysqli_query($conexion,"SELECT u.idusuario, u.nombre, u.correo, u.usuario, r.rol FROM usuario u INNER JOIN rol r ON u.rol = r.idrol WHERE estatus = 0  ORDER BY idusuario ASC LIMIT $desde,$por_pagina");
