							 	...
							 	while ($data = mysqli_fetch_array($query)) {
							 		...
							 		<tr class="row<?php echo $data['codproducto']; ?>">
										...
										<td class='text-center'>
											<a href="cliente_ver.php?id=<?php echo $data['codproducto']; ?>" class="look"><i class="fa fa-eye"></i></a>
										</td>
										<td class='text-center'>
											<a href="cliente_editar.php?id=<?php echo $data['codproducto']; ?>" class="edit"><i class="fa fa-edit"></i></a>
										</td>
										<td class='text-center'>
											<a href="cliente_borrar.php?id=<?php echo $data['codproducto']; ?>" class="delete eliminar"><i class="fa fa-trash-alt"></i></a>
										</td>
									</tr>
